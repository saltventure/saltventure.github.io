...
const Tenzies = ({ user, updateUser }: Props)=> {
  ...
  const allNewDice = async () => {
    ...
    try {
        const response = await fetch("https://salt-venture.azurewebsites.net/api/tenzies", requestSettings)
        if (!response.ok) {
  ...
  const pickPositions = async () => {
    ...
    try {
        const response = await fetch("https://salt-venture.azurewebsites.net/api/tenzies/pick/" + holding, requestSettings)
        if (!response.ok) {
            throw new Error(JSON.stringify(await response.json()));
        }
        const deserializedJSON = await response.json();  
  ...
  const getReward = async () => {
    ...
    try {
        const response = await fetch("https://salt-venture.azurewebsites.net/api/tenzies/getreward", requestSettings)
        if (!response.ok) {
            throw new Error(JSON.stringify(await response.json()));
        }
        const deserializedJSON = await response.json();
