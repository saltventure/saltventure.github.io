...
function Tower({ user, updateUser }: Props) {
    ...
    const pickItem = async (id, floor) => {
        ...
        try {
            const response = await fetch("https://salt-ventures.azurewebsites.net/api/tower/pick/"+id, requestSettings)
            if (!response.ok) {
    ...
    const checkExistingGame = async ()=> {
        ...
        try {
            const response = await fetch("https://salt-ventures.azurewebsites.net/api/tower", requestSettings)
            if (!response.ok) {
                throw new Error(JSON.stringify(await response.json()));
            }
    ...
    const cashOut = async() => {
        ...
        try {
            const response = await fetch("https://salt-ventures.azurewebsites.net/api/tower/cashout", requestSettings)
            if (!response.ok) {
                throw new Error(JSON.stringify(await response.json()));
            }
            setIsWin(true);
